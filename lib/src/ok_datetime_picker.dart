...
class _OkDateTimePickerWidgetState extends State<OkDateTimePickerWidget> {
  ...
  void initState() {
    super.initState();
    selectedDateTime = DateTimeEntity.fromDateTime(widget.initialTime ?? DateTime.now());
  }
